...
Page({
  data: {
    ...
    rightData: [
      {
        name:'概述',
        content:'<h1><strong>概述</strong></h1> <hr /> <p>流感是一种通过咳嗽和打喷嚏传播的、常见的病毒感染性疾病。感染流感病毒后，身体会出现高热、乏力、咳嗽、全身疼痛等不适，但是通常在一周左右症状会缓解。流感可以在一年四季流行，但在冬天特别常见，这就是为什么它也被称为“季节性流感”。 与普通感冒不同的是，流感是由一组特殊的病毒引起，并且流感的症状出现得更突然、更严重，也持续得更久。流感的主要症状包括：38℃以上的发热、乏力、头痛、全身疼痛、支气管炎样的干咳，以及与普通感冒类似的症状，如鼻塞、流涕、打喷嚏和咽痛。流感会导致明显的疲乏感，因此需要卧床休息。</p><p>上传图片1<img src=\"http://127.0.0.1/media/picture/20200810/92725ca6-68ad-4432-8488-765f9d5cb60b.jpg\" width=\"40%\" data-custom=\"id=abcd&amp;role=god\"></p>  ',
        id: 'cp1',
      },
      {
        name: '病因',
      ...
      {
        name: '治疗方法',
        content:'<h1><strong>治疗方法</strong></h1>  <hr/>  <p>流感患者大多数为轻症病例，治疗可分为一般治疗、抗病毒治疗、中医治疗等方法，如果症状较为严重，建议及时到医院就诊，听从医生的建议进行相应的检查和治疗。</p>  <p>流感高危人群容易引发重症流感，尽早抗病毒治疗可减轻症状，减少并发症，缩短病程，降低病死率。</p>  <h2>对于符合下列标准1条或1条以上的情况，建议住院治疗：</h2>  <li> 妊娠中晚期及围产期妇女；</li>  <li> 基础疾病明显加重，如慢性阻塞性肺疾病、糖尿病、慢性心功能不全、慢性肾功能不全、肝硬化等；</li>  <li> 符合重症或危重流感诊断标准；</li>  <li> 伴有器官功能障碍。</li>',
        id: 'cp6',
      },
      {
        name: '预防',
        content:'<h1><strong>预防</strong></h1>  <hr/>  <p>如果感染了流感，完全可以通过正确的防范措施防止传染给他人：经常用温水和肥皂洗手；经常清洁电脑键盘、电话、门把手的表面；咳嗽或者打喷嚏的时候用纸巾遮住嘴巴和鼻子；将用过的纸巾及时扔进垃圾桶；患病期间减少和其他人不必要的接触（完全康复后再去上班或者上学）。对于感染流感后存在严重风险的人群，建议每年接种流感疫苗，来减少感染几率。</p>  ',
        id: 'cp7',

      },
      {
        name: '高危人群',
        content:'<h1><strong>高危人群</strong></h1>  <hr/>  <p>一般感染流感病毒数天后，机体就会出现不适症状。大概一周左右，多数症状就会逐渐缓解。但是完全康复还需要花更长的时间。</p>  <p>症状开始的时候传染性是最强的。这种传染性大概会持续3-7天。儿童和免疫力较弱的人的传染性可能会持续更长时间。绝大多数人最终都会完全康复，并且不遗留任何后遗症。但是有基础疾病的老年人的预后相对较差，可能会出现较严重的并发症，如肺部感染。</p>',
        id: 'cp8',
